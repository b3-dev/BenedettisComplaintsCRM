...
<div class="card text-left border-0 mt-0">
    <div class="card-header" style="background-color: #FFF">
        ...
        <h3>Solicitudes registradas en tu zona ({{date('Y')}})</h3>
    </div>
    ...
    <div class="card-body">
        ...
        <table id="table" data-toolbar="#toolbar" data-search="false" data-show-refresh="false" data-show-toggle="true" data-show-fullscreen="false" data-show-columns="true" data-show-columns-toggle-all="true" data-detail-view="false" data-header-style="headerStyle" data-show-export="true" data-click-to-select="true" data-detail-formatter="detailFormatter" data-minimum-count-columns="2" data-show-pagination-switch="false" data-pagination="true" data-id-field="id" data-page-list="[10, 25, 50, 100, all]" data-show-footer="false" data-side-pagination="server" data-ajax-options="ajaxOptions" data-url="{{ url('/api/complaints/getComplaintsByManager') }}" data-response-handler="responseHandler">
        </table>
        ...
        <script type="text/javascript">
                ...
                'click .details': function(e, value, row, index) {
                    getComplaintInfo(row.complaint_id).then(function(data) {
                        ...
                        if (data['data'].length) {
                            ...
                            $('#modalComplaintInfoByManager').modal('show');
            ...
            function getComplaintsByParams(THAT, e) {
                ...
                $table.bootstrapTable("refresh", {
                    url: raiz_url + "/api/complaints/getComplaintsByManager?store_id=" + $('#param_store_id').val() +
...
<!--MODAL -->
@include('modals.modalComplaintInfoByManager')
