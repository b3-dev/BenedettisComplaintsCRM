...
<div class="card text-left border-0 mt-0">
    <div class="card-header" style="background-color: #FFF">
        ...
        <h3>Mis solicitudes registradas ({{date('Y')}})</h3>
    </div>
    <div class="card-body">
        <!--datatable -->
        <style>
        ...
        <table id="table" data-toolbar="#toolbar"
            data-search="false" data-show-refresh="false" data-show-toggle="true" data-show-fullscreen="false"
            data-show-columns="true" data-show-columns-toggle-all="true" data-detail-view="false" data-show-export="true"
            data-click-to-select="false" data-detail-formatter="detailFormatter"
            ...
            data-show-footer="false" data-side-pagination="server" data-ajax-options="ajaxOptions"
            data-url="{{ url('/api/complaints/getComplaintsByPartner') }}" data-response-handler="responseHandler">
        </table>
        ...
        <script>
            ...
            function operateFormatter(value, row, index) {
                ...
                return [
                    ...
                    '</a>  ',
                    '<a class="pdf" onclick="javascript:aOnClick(this)" href="' + raiz_url + '/complaints/complaintPDF/id/' + row.complaint_id + '" title="pdf">',
                ...
                'click .details': function(e, value, row, index) {
                    getComplaintInfo(row.complaint_id).then(function(data) {
                        ...
                        if (data['data'].length) {
                            ...
                            $('#modalComplaintInfoByPartner').modal('show');
...
<!--MODAL -->
@include('modals.modalComplaintInfoByPartner')
