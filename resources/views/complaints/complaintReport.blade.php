...
<script src="{{ URL::asset('assets/bootstrap-table-master/dist/bootstrap-table.js') }}"></script>
    ...
    <script type="text/javascript">
            ...
            'click .details': function(e, value, row, index) {
                getComplaintInfo(row.complaint_id).then(function(data) {
                    ...
                    if (data['data'].length) {
                        ...
                        if (data['data'][0].status_id == 1) { //queja pendiente
        ...
        function getComplaintsByParams(THAT, e) {
            ...
            $table.bootstrapTable("refresh", {
                url: raiz_url + "/api/complaints/getComplaints?store_id=" + $('#param_store_id').val() +
...
<!--MODAL -->
@include('modals.modalComplaintInfo')
