...
<body class="text-center m-4">
    <div class="m-auto" style="width:500px;">
        ...
        <h5 class="mb-3 font-weight-normal textBeneGreen "> <i class="far fa-check-circle fa-fw fa-2x"></i>
            Contraseña temporal generada correctamente</h5>

        <h7 class="mt-3">Hemos enviado a tu <b>email registrado</b> una contraseña temporal de acceso.
            Es importante que cambies la contraseña temporal a la brevedad.
            <br />
            <br />
            Si tienes alguna duda, comunicate al área de sistemas.</h7>
        <br />
        <a href="{{URL('/')}}">
