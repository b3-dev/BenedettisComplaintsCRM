...
<body class="text-center m-4">
    <div class="m-auto" style="width:500px;">
        ...
        La encuesta ha sido respondida correctamente
        </h5>

        <h7 class="mt-3">¡Muchas gracias por tu tiempo! . <br />Hemos recibido satisfactoriamente tus respuestas y comentarios los cuales nos ayudan en gran medida a mejorar nuestro servicio y atención.
