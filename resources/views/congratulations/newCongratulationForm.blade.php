...
<div class="card text-left border-0 mt-0">
    <form name="formCreateCongratulation" id="formCreateCongratulation" action="{{url('/api/congratulations/createCongratulation')}}" role="form" data-toggle="validator" method="post">

        <div class="card-header" style="background-color: #FFF">
            <!--<h4>Especialidades y pizzas</h4>-->
            <h3>Nueva felicitación </h3>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12 mt-2">
                    <h6>Por favor, describe la felicitación</h6>
                    <div class="form-group ">
                        <textarea class="form-control" required id="post_description" name="post_description" placeholder="Ejem: describenos tu felicitación aquí"></textarea>
                        <div class="help-block with-errors"></div>
                    </div>
