        ...
        <form name="formUpdateUserProfile" id="formUpdateUserProfile" action="{{url('profile/updateUserProfile')}}" role="form" data-toggle="validator" method="post">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="form-group ">
                        <input type="text" class="form-control" value="{{$data['array_user'][0]->first_name}}" required id="post_first_name" name="post_first_name" placeholder="Nombre(s) ">
                        <div class="help-block with-errors"></div>
                    </div>
                    <h6>Teléfono de contacto</h6>
                    <div class="form-group ">
                        <input type="text" class="form-control" pattern="^[0-9]{1,}$" maxlength="10" value="{{$data['array_user'][0]->phone}}" required id="post_phone" name="post_phone" placeholder="ejem:5555023141">
                        <div class="help-block with-errors"></div>
                    </div>
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <h6>Apellidos(s)</h6>
                    <div class="form-group ">
                        <input type="text" class="form-control" value="{{$data['array_user'][0]->last_name}}" required id="post_last_name" name="post_last_name" placeholder="Apellido(s)">
                        <div class="help-block with-errors"></div>
                    </div>
                    <h6>Email</h6>
                    <div class="form-group ">
                        <input type="text" class="form-control" disabled maxlength="10" value="{{$data['array_user'][0]->email}}" required id="post_email" name="post_email" placeholder="ejem:5555023141">
            ...
            <div class="row">
                <div class="col-md-12 text-right">
                    ...
                    <h7 id="msgUpdateProfile" style="display:none"> actualizados correctamente</h7>
                    <br />
                    <br />
