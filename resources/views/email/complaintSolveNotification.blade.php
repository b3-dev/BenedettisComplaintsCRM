...
<body class="text-center m-4">
    <div class="m-auto" style="background-color:#FFF !important;">
        ...
        <h6 class="mb-3 font-weight-normal textBeneSuccess"><i class="fas fa-check-circle fa-fw"></i> Enhorabuena tu solicitud ha sido atendida</h6>
        ...
        <hr />
        <h7 class="mt-1"><b>Respuesta ó solución <small>{{$complaint_solved_date}}</small></b></h7>
        <br />
        <p class="text-justify mt-2" style="max-width:500px !important;">
            {{ $complaint_solution }}
        </p>
        <br />
        <h7>¡Es un placer atenderte!
            <br />
